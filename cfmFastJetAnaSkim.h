...
void GetAnaBranches(sampleType sType = kHIDATA, Bool_t isGen = false)
{
  ...
  if(montecarlo){
    ...
    genTreeAna_p->SetBranchAddress("genJtRawPt", genJtRawPhi_);
    genTreeAna_p->SetBranchAddress("genJtRawPt", genJtRawEta_);
    ...
    genTreeAna_p->SetBranchAddress("genJtSKPt", genJtSKPhi_);
    genTreeAna_p->SetBranchAddress("genJtSKPt", genJtSKEta_);
