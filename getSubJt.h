...
void getSubJet(fastjet::PseudoJet inJt, const Double_t subJtR, fastjet::JetAlgorithm subJtAlg, Int_t nSubJt, Float_t subPt[], Float_t subPhi[], Float_t subEta[])
{
  ...
  if(nSubJt > subJts.size()) nSubJt = subJts.size();
