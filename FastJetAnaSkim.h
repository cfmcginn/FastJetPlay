...
Float_t rechitJtRawMatchPt_[maxJets];
Float_t rechitJtRawMatchPhi_[maxJets];
Float_t rechitJtRawMatchEta_[maxJets];
Int_t rechitJtRawConstN_[maxJets];
Float_t rechitJtRawSoftPt_[maxJets];
Float_t rechitJtRawPTD_[maxJets];
Float_t rechitJtRawChg_[maxJets];
...
Float_t rechitJtVsMatchPt_[maxJets];
Float_t rechitJtVsMatchPhi_[maxJets];
Float_t rechitJtVsMatchEta_[maxJets];
Int_t rechitJtVsConstN_[maxJets];
Float_t rechitJtVsSoftPt_[maxJets];
Float_t rechitJtVsPTD_[maxJets];
Float_t rechitJtVsChg_[maxJets];
...
Float_t pfJtRawMatchPt_[maxJets];
Float_t pfJtRawMatchPhi_[maxJets];
Float_t pfJtRawMatchEta_[maxJets];
Int_t pfJtRawConstN_[maxJets];
Float_t pfJtRawSoftPt_[maxJets];
Float_t pfJtRawPTD_[maxJets];
Float_t pfJtRawChg_[maxJets];
...
Float_t pfJtVsMatchPt_[maxJets];
Float_t pfJtVsMatchPhi_[maxJets];
Float_t pfJtVsMatchEta_[maxJets];
Int_t pfJtVsConstN_[maxJets];
Float_t pfJtVsSoftPt_[maxJets];
Float_t pfJtVsPTD_[maxJets];
Float_t pfJtVsChg_[maxJets];
...
Float_t pfJtSKMatchPt_[maxJets];
Float_t pfJtSKMatchPhi_[maxJets];
Float_t pfJtSKMatchEta_[maxJets];
Int_t pfJtSKConstN_[maxJets];
Float_t pfJtSKSoftPt_[maxJets];
Float_t pfJtSKPTD_[maxJets];
Float_t pfJtSKChg_[maxJets];
...
Float_t trkJtRawMatchPt_[maxJets];
Float_t trkJtRawMatchPhi_[maxJets];
Float_t trkJtRawMatchEta_[maxJets];
Int_t trkJtRawConstN_[maxJets];
Float_t trkJtRawSoftPt_[maxJets];
Float_t trkJtRawPTD_[maxJets];
Float_t trkJtRawChg_[maxJets];
...
Float_t trkJtSKMatchPt_[maxJets];
Float_t trkJtSKMatchPhi_[maxJets];
Float_t trkJtSKMatchEta_[maxJets];
Int_t trkJtSKConstN_[maxJets];
Float_t trkJtSKSoftPt_[maxJets];
Float_t trkJtSKPTD_[maxJets];
Float_t trkJtSKChg_[maxJets];
...
Float_t genJtRawMatchPt_[maxJets];
Float_t genJtRawMatchPhi_[maxJets];
Float_t genJtRawMatchEta_[maxJets];
Int_t genJtRawConstN_[maxJets];
Float_t genJtRawSoftPt_[maxJets];
Float_t genJtRawPTD_[maxJets];
Float_t genJtRawChg_[maxJets];
...
Float_t genJtSKMatchPt_[maxJets];
Float_t genJtSKMatchPhi_[maxJets];
Float_t genJtSKMatchEta_[maxJets];
Int_t genJtSKConstN_[maxJets];
Float_t genJtSKSoftPt_[maxJets];
Float_t genJtSKPTD_[maxJets];
Float_t genJtSKChg_[maxJets];
...
Float_t genJtSUBEMatchPt_[maxJets];
Float_t genJtSUBEMatchPhi_[maxJets];
Float_t genJtSUBEMatchEta_[maxJets];
Int_t genJtSUBEConstN_[maxJets];
Float_t genJtSUBESoftPt_[maxJets];
Float_t genJtSUBEPTD_[maxJets];
Float_t genJtSUBEChg_[maxJets];
...
void SetAnaBranches(sampleType sType = kHIDATA, Bool_t isGen = false)
{
  ...
  if(!isGen){
    ...
    rechitTreeAna_p->Branch("rechitJtRawMatchPt", rechitJtRawMatchPt_, Form("rechitJtRawMatchPt[nRechitJtRaw]/F"));
    rechitTreeAna_p->Branch("rechitJtRawMatchPhi", rechitJtRawMatchPhi_, Form("rechitJtRawMatchPhi[nRechitJtRaw]/F"));
    rechitTreeAna_p->Branch("rechitJtRawMatchEta", rechitJtRawMatchEta_, Form("rechitJtRawMatchEta[nRechitJtRaw]/F"));
    rechitTreeAna_p->Branch("rechitJtRawConstN", rechitJtRawConstN_, Form("rechitJtRawConstN[nRechitJtRaw]/I"));
    rechitTreeAna_p->Branch("rechitJtRawSoftPt", rechitJtRawSoftPt_, Form("rechitJtRawSoftPt[nRechitJtRaw]/F"));
    rechitTreeAna_p->Branch("rechitJtRawPTD", rechitJtRawPTD_, Form("rechitJtRawPTD[nRechitJtRaw]/F"));
    rechitTreeAna_p->Branch("rechitJtRawChg", rechitJtRawChg_, Form("rechitJtRawChg[nRechitJtRaw]/F"));
    ...
    rechitTreeAna_p->Branch("rechitJtVsMatchPt", rechitJtVsMatchPt_, Form("rechitJtVsMatchPt[nRechitJtVs]/F"));
    rechitTreeAna_p->Branch("rechitJtVsMatchPhi", rechitJtVsMatchPhi_, Form("rechitJtVsMatchPhi[nRechitJtVs]/F"));
    rechitTreeAna_p->Branch("rechitJtVsMatchEta", rechitJtVsMatchEta_, Form("rechitJtVsMatchEta[nRechitJtVs]/F"));
    rechitTreeAna_p->Branch("rechitJtVsConstN", rechitJtVsConstN_, Form("rechitJtVsConstN[nRechitJtVs]/I"));
    rechitTreeAna_p->Branch("rechitJtVsSoftPt", rechitJtVsSoftPt_, Form("rechitJtVsSoftPt[nRechitJtVs]/F"));
    rechitTreeAna_p->Branch("rechitJtVsPTD", rechitJtVsPTD_, Form("rechitJtVsPTD[nRechitJtVs]/F"));
    rechitTreeAna_p->Branch("rechitJtVsChg", rechitJtVsChg_, Form("rechitJtVsChg[nRechitJtVs]/F"));
    ...
    pfcandTreeAna_p->Branch("pfJtRawMatchPt", pfJtRawMatchPt_, Form("pfJtRawMatchPt[nPFJtRaw]/F"));
    pfcandTreeAna_p->Branch("pfJtRawMatchPhi", pfJtRawMatchPhi_, Form("pfJtRawMatchPhi[nPFJtRaw]/F"));
    pfcandTreeAna_p->Branch("pfJtRawMatchEta", pfJtRawMatchEta_, Form("pfJtRawMatchEta[nPFJtRaw]/F"));
    pfcandTreeAna_p->Branch("pfJtRawConstN", pfJtRawConstN_, Form("pfJtRawConstN[nPFJtRaw]/I"));
    pfcandTreeAna_p->Branch("pfJtRawSoftPt", pfJtRawSoftPt_, Form("pfJtRawSoftPt[nPFJtRaw]/F"));
    pfcandTreeAna_p->Branch("pfJtRawPTD", pfJtRawPTD_, Form("pfJtRawPTD[nPFJtRaw]/F"));
    pfcandTreeAna_p->Branch("pfJtRawChg", pfJtRawChg_, Form("pfJtRawChg[nPFJtRaw]/F"));
    ...
    pfcandTreeAna_p->Branch("pfJtVsMatchPt", pfJtVsMatchPt_, Form("pfJtVsMatchPt[nPFJtVs]/F"));
    pfcandTreeAna_p->Branch("pfJtVsMatchPhi", pfJtVsMatchPhi_, Form("pfJtVsMatchPhi[nPFJtVs]/F"));
    pfcandTreeAna_p->Branch("pfJtVsMatchEta", pfJtVsMatchEta_, Form("pfJtVsMatchEta[nPFJtVs]/F"));
    pfcandTreeAna_p->Branch("pfJtVsConstN", pfJtVsConstN_, Form("pfJtVsConstN[nPFJtVs]/I"));
    pfcandTreeAna_p->Branch("pfJtVsSoftPt", pfJtVsSoftPt_, Form("pfJtVsSoftPt[nPFJtVs]/F"));
    pfcandTreeAna_p->Branch("pfJtVsPTD", pfJtVsPTD_, Form("pfJtVsPTD[nPFJtVs]/F"));
    pfcandTreeAna_p->Branch("pfJtVsChg", pfJtVsChg_, Form("pfJtVsChg[nPFJtVs]/F"));
    ...
    pfcandTreeAna_p->Branch("pfJtSKMatchPt", pfJtSKMatchPt_, Form("pfJtSKMatchPt[nPFJtSK]/F"));
    pfcandTreeAna_p->Branch("pfJtSKMatchPhi", pfJtSKMatchPhi_, Form("pfJtSKMatchPhi[nPFJtSK]/F"));
    pfcandTreeAna_p->Branch("pfJtSKMatchEta", pfJtSKMatchEta_, Form("pfJtSKMatchEta[nPFJtSK]/F"));
    pfcandTreeAna_p->Branch("pfJtSKConstN", pfJtSKConstN_, Form("pfJtSKConstN[nPFJtSK]/I"));
    pfcandTreeAna_p->Branch("pfJtSKSoftPt", pfJtSKSoftPt_, Form("pfJtSKSoftPt[nPFJtSK]/F"));
    pfcandTreeAna_p->Branch("pfJtSKPTD", pfJtSKPTD_, Form("pfJtSKPTD[nPFJtSK]/F"));
    pfcandTreeAna_p->Branch("pfJtSKChg", pfJtSKChg_, Form("pfJtSKChg[nPFJtSK]/F"));
    ...
    trkTreeAna_p->Branch("trkJtRawMatchPt", trkJtRawMatchPt_, Form("trkJtRawMatchPt[nTrkJtRaw]/F"));
    trkTreeAna_p->Branch("trkJtRawMatchPhi", trkJtRawMatchPhi_, Form("trkJtRawMatchPhi[nTrkJtRaw]/F"));
    trkTreeAna_p->Branch("trkJtRawMatchEta", trkJtRawMatchEta_, Form("trkJtRawMatchEta[nTrkJtRaw]/F"));
    trkTreeAna_p->Branch("trkJtRawConstN", trkJtRawConstN_, Form("trkJtRawConstN[nTrkJtRaw]/I"));
    trkTreeAna_p->Branch("trkJtRawSoftPt", trkJtRawSoftPt_, Form("trkJtRawSoftPt[nTrkJtRaw]/F"));
    trkTreeAna_p->Branch("trkJtRawPTD", trkJtRawPTD_, Form("trkJtRawPTD[nTrkJtRaw]/F"));
    trkTreeAna_p->Branch("trkJtRawChg", trkJtRawChg_, Form("trkJtRawChg[nTrkJtRaw]/F"));
    ...
    trkTreeAna_p->Branch("trkJtSKMatchPt", trkJtSKMatchPt_, Form("trkJtSKMatchPt[nTrkJtSK]/F"));
    trkTreeAna_p->Branch("trkJtSKMatchPhi", trkJtSKMatchPhi_, Form("trkJtSKMatchPhi[nTrkJtSK]/F"));
    trkTreeAna_p->Branch("trkJtSKMatchEta", trkJtSKMatchEta_, Form("trkJtSKMatchEta[nTrkJtSK]/F"));
    trkTreeAna_p->Branch("trkJtSKConstN", trkJtSKConstN_, Form("trkJtSKConstN[nTrkJtSK]/I"));
    trkTreeAna_p->Branch("trkJtSKSoftPt", trkJtSKSoftPt_, Form("trkJtSKSoftPt[nTrkJtSK]/F"));
    trkTreeAna_p->Branch("trkJtSKPTD", trkJtSKPTD_, Form("trkJtSKPTD[nTrkJtSK]/F"));
    trkTreeAna_p->Branch("trkJtSKChg", trkJtSKChg_, Form("trkJtSKChg[nTrkJtSK]/F"));
  ...
  if(montecarlo){
    ...
    genTreeAna_p->Branch("genJtRawMatchPt", genJtRawMatchPt_, Form("genJtRawMatchPt[nGenJtRaw]/F"));
    genTreeAna_p->Branch("genJtRawMatchPhi", genJtRawMatchPhi_, Form("genJtRawMatchPhi[nGenJtRaw]/F"));
    genTreeAna_p->Branch("genJtRawMatchEta", genJtRawMatchEta_, Form("genJtRawMatchEta[nGenJtRaw]/F"));
    genTreeAna_p->Branch("genJtRawConstN", genJtRawConstN_, Form("genJtRawConstN[nGenJtRaw]/I"));
    genTreeAna_p->Branch("genJtRawSoftPt", genJtRawSoftPt_, Form("genJtRawSoftPt[nGenJtRaw]/F"));
    genTreeAna_p->Branch("genJtRawPTD", genJtRawPTD_, Form("genJtRawPTD[nGenJtRaw]/F"));
    genTreeAna_p->Branch("genJtRawChg", genJtRawChg_, Form("genJtRawChg[nGenJtRaw]/F"));
    ...
    genTreeAna_p->Branch("genJtSKMatchPt", genJtSKMatchPt_, Form("genJtSKMatchPt[nGenJtSK]/F"));
    genTreeAna_p->Branch("genJtSKMatchPhi", genJtSKMatchPhi_, Form("genJtSKMatchPhi[nGenJtSK]/F"));
    genTreeAna_p->Branch("genJtSKMatchEta", genJtSKMatchEta_, Form("genJtSKMatchEta[nGenJtSK]/F"));
    genTreeAna_p->Branch("genJtSKConstN", genJtSKConstN_, Form("genJtSKConstN[nGenJtSK]/I"));
    genTreeAna_p->Branch("genJtSKSoftPt", genJtSKSoftPt_, Form("genJtSKSoftPt[nGenJtSK]/F"));
    genTreeAna_p->Branch("genJtSKPTD", genJtSKPTD_, Form("genJtSKPTD[nGenJtSK]/F"));
    genTreeAna_p->Branch("genJtSKChg", genJtSKChg_, Form("genJtSKChg[nGenJtSK]/F"));
    ...
    genTreeAna_p->Branch("genJtSUBEMatchPt", genJtSUBEMatchPt_, Form("genJtSUBEMatchPt[nGenJtSUBE]/F"));
    genTreeAna_p->Branch("genJtSUBEMatchPhi", genJtSUBEMatchPhi_, Form("genJtSUBEMatchPhi[nGenJtSUBE]/F"));
    genTreeAna_p->Branch("genJtSUBEMatchEta", genJtSUBEMatchEta_, Form("genJtSUBEMatchEta[nGenJtSUBE]/F"));
    genTreeAna_p->Branch("genJtSUBEConstN", genJtSUBEConstN_, Form("genJtSUBEConstN[nGenJtSUBE]/I"));
    genTreeAna_p->Branch("genJtSUBESoftPt", genJtSUBESoftPt_, Form("genJtSUBESoftPt[nGenJtSUBE]/F"));
    genTreeAna_p->Branch("genJtSUBEPTD", genJtSUBEPTD_, Form("genJtSUBEPTD[nGenJtSUBE]/F"));
    genTreeAna_p->Branch("genJtSUBEChg", genJtSUBEChg_, Form("genJtSUBEChg[nGenJtSUBE]/F"));
...
void GetAnaBranches(sampleType sType = kHIDATA, Bool_t isGen = false)
{
  ...
  if(!isGen){
    ...
    rechitTreeAna_p->SetBranchAddress("rechitJtRawMatchPt", rechitJtRawMatchPt_);
    rechitTreeAna_p->SetBranchAddress("rechitJtRawMatchPhi", rechitJtRawMatchPhi_);
    rechitTreeAna_p->SetBranchAddress("rechitJtRawMatchEta", rechitJtRawMatchEta_);
    rechitTreeAna_p->SetBranchAddress("rechitJtRawConstN", rechitJtRawConstN_);
    rechitTreeAna_p->SetBranchAddress("rechitJtRawSoftPt", rechitJtRawSoftPt_);
    rechitTreeAna_p->SetBranchAddress("rechitJtRawPTD", rechitJtRawPTD_);
    rechitTreeAna_p->SetBranchAddress("rechitJtRawChg", rechitJtRawChg_);
    ...
    rechitTreeAna_p->SetBranchAddress("rechitJtVsMatchPt", rechitJtVsMatchPt_);
    rechitTreeAna_p->SetBranchAddress("rechitJtVsMatchPhi", rechitJtVsMatchPhi_);
    rechitTreeAna_p->SetBranchAddress("rechitJtVsMatchEta", rechitJtVsMatchEta_);
    rechitTreeAna_p->SetBranchAddress("rechitJtVsConstN", rechitJtVsConstN_);
    rechitTreeAna_p->SetBranchAddress("rechitJtVsSoftPt", rechitJtVsSoftPt_);
    rechitTreeAna_p->SetBranchAddress("rechitJtVsPTD", rechitJtVsPTD_);
    rechitTreeAna_p->SetBranchAddress("rechitJtVsChg", rechitJtVsChg_);
    ...
    pfcandTreeAna_p->SetBranchAddress("pfJtRawMatchPt", pfJtRawMatchPt_);
    pfcandTreeAna_p->SetBranchAddress("pfJtRawMatchPhi", pfJtRawMatchPhi_);
    pfcandTreeAna_p->SetBranchAddress("pfJtRawMatchEta", pfJtRawMatchEta_);
    pfcandTreeAna_p->SetBranchAddress("pfJtRawConstN", pfJtRawConstN_);
    pfcandTreeAna_p->SetBranchAddress("pfJtRawSoftPt", pfJtRawSoftPt_);
    pfcandTreeAna_p->SetBranchAddress("pfJtRawPTD", pfJtRawPTD_);
    pfcandTreeAna_p->SetBranchAddress("pfJtRawChg", pfJtRawChg_);
    ...
    pfcandTreeAna_p->SetBranchAddress("pfJtVsMatchPt", pfJtVsMatchPt_);
    pfcandTreeAna_p->SetBranchAddress("pfJtVsMatchPhi", pfJtVsMatchPhi_);
    pfcandTreeAna_p->SetBranchAddress("pfJtVsMatchEta", pfJtVsMatchEta_);
    pfcandTreeAna_p->SetBranchAddress("pfJtVsConstN", pfJtVsConstN_);
    pfcandTreeAna_p->SetBranchAddress("pfJtVsSoftPt", pfJtVsSoftPt_);
    pfcandTreeAna_p->SetBranchAddress("pfJtVsPTD", pfJtVsPTD_);
    pfcandTreeAna_p->SetBranchAddress("pfJtVsChg", pfJtVsChg_);
    ...
    pfcandTreeAna_p->SetBranchAddress("pfJtSKMatchPt", pfJtSKMatchPt_);
    pfcandTreeAna_p->SetBranchAddress("pfJtSKMatchPhi", pfJtSKMatchPhi_);
    pfcandTreeAna_p->SetBranchAddress("pfJtSKMatchEta", pfJtSKMatchEta_);
    pfcandTreeAna_p->SetBranchAddress("pfJtSKConstN", pfJtSKConstN_);
    pfcandTreeAna_p->SetBranchAddress("pfJtSKSoftPt", pfJtSKSoftPt_);
    pfcandTreeAna_p->SetBranchAddress("pfJtSKPTD", pfJtSKPTD_);
    pfcandTreeAna_p->SetBranchAddress("pfJtSKChg", pfJtSKChg_);
    ...
    trkTreeAna_p->SetBranchAddress("trkJtRawMatchPt", trkJtRawMatchPt_);
    trkTreeAna_p->SetBranchAddress("trkJtRawMatchPhi", trkJtRawMatchPhi_);
    trkTreeAna_p->SetBranchAddress("trkJtRawMatchEta", trkJtRawMatchEta_);
    trkTreeAna_p->SetBranchAddress("trkJtRawConstN", trkJtRawConstN_);
    trkTreeAna_p->SetBranchAddress("trkJtRawSoftPt", trkJtRawSoftPt_);
    trkTreeAna_p->SetBranchAddress("trkJtRawPTD", trkJtRawPTD_);
    trkTreeAna_p->SetBranchAddress("trkJtRawChg", trkJtRawChg_);
    ...
    trkTreeAna_p->SetBranchAddress("trkJtSKMatchPt", trkJtSKMatchPt_);
    trkTreeAna_p->SetBranchAddress("trkJtSKMatchPhi", trkJtSKMatchPhi_);
    trkTreeAna_p->SetBranchAddress("trkJtSKMatchEta", trkJtSKMatchEta_);
    trkTreeAna_p->SetBranchAddress("trkJtSKConstN", trkJtSKConstN_);
    trkTreeAna_p->SetBranchAddress("trkJtSKSoftPt", trkJtSKSoftPt_);
    trkTreeAna_p->SetBranchAddress("trkJtSKPTD", trkJtSKPTD_);
    trkTreeAna_p->SetBranchAddress("trkJtSKChg", trkJtSKChg_);
  ...
  if(montecarlo){
    ...
    genTreeAna_p->SetBranchAddress("genJtRawMatchPt", genJtRawMatchPt_);
    genTreeAna_p->SetBranchAddress("genJtRawMatchPhi", genJtRawMatchPhi_);
    genTreeAna_p->SetBranchAddress("genJtRawMatchEta", genJtRawMatchEta_);
    genTreeAna_p->SetBranchAddress("genJtRawConstN", genJtRawConstN_);
    genTreeAna_p->SetBranchAddress("genJtRawSoftPt", genJtRawSoftPt_);
    genTreeAna_p->SetBranchAddress("genJtRawPTD", genJtRawPTD_);
    genTreeAna_p->SetBranchAddress("genJtRawChg", genJtRawChg_);
    ...
    genTreeAna_p->SetBranchAddress("genJtSKMatchPt", genJtSKMatchPt_);
    genTreeAna_p->SetBranchAddress("genJtSKMatchPhi", genJtSKMatchPhi_);
    genTreeAna_p->SetBranchAddress("genJtSKMatchEta", genJtSKMatchEta_);
    genTreeAna_p->SetBranchAddress("genJtSKConstN", genJtSKConstN_);
    genTreeAna_p->SetBranchAddress("genJtSKSoftPt", genJtSKSoftPt_);
    genTreeAna_p->SetBranchAddress("genJtSKPTD", genJtSKPTD_);
    genTreeAna_p->SetBranchAddress("genJtSKChg", genJtSKChg_);
    ...
    genTreeAna_p->SetBranchAddress("genJtSUBEMatchPt", genJtSUBEMatchPt_);
    genTreeAna_p->SetBranchAddress("genJtSUBEMatchPhi", genJtSUBEMatchPhi_);
    genTreeAna_p->SetBranchAddress("genJtSUBEMatchEta", genJtSUBEMatchEta_);
    genTreeAna_p->SetBranchAddress("genJtSUBEConstN", genJtSUBEConstN_);
    genTreeAna_p->SetBranchAddress("genJtSUBESoftPt", genJtSUBESoftPt_);
    genTreeAna_p->SetBranchAddress("genJtSUBEPTD", genJtSUBEPTD_);
    genTreeAna_p->SetBranchAddress("genJtSUBEChg", genJtSUBEChg_);
