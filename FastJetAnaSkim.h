...
void SetAnaBranches(sampleType sType = kHIDATA, Bool_t isGen = false)
{
  ...
  if(!isGen){
    ...
    rechitTreeAna_p->Branch("rechitJtRawSigma", rechitJtRawSigma_, "rechitJtRawSigma[5][3]/F");
    rechitTreeAna_p->Branch("rechitJtRawRefPart", rechitJtRawRefPart_, "rechitJtRawRefPart[5]/I");
    rechitTreeAna_p->Branch("rechitRawTau", rechitRawTau_, "rechitRawTau[5][3][6]/F");
    ...
    rechitTreeAna_p->Branch("rechitJtVsSigma", rechitJtVsSigma_, "rechitJtVsSigma[5][3]/F");
    rechitTreeAna_p->Branch("rechitJtVsRefPart", rechitJtVsRefPart_, "rechitJtVsRefPart[5]/I");
    rechitTreeAna_p->Branch("rechitVsTau", rechitVsTau_, "rechitVsTau[5][3][6]/F");
    ...
    pfcandTreeAna_p->Branch("pfJtRawSigma", pfJtRawSigma_, "pfJtRawSigma[5][3]/F");
    pfcandTreeAna_p->Branch("pfJtRawRefPart", pfJtRawRefPart_, "pfJtRawRefPart[5]/I");
    pfcandTreeAna_p->Branch("pfRawTau", pfRawTau_, "pfRawTau[5][3][6]/F");
    ...
    pfcandTreeAna_p->Branch("pfJtVsSigma", pfJtVsSigma_, "pfJtVsSigma[5][3]/F");
    pfcandTreeAna_p->Branch("pfJtVsRefPart", pfJtVsRefPart_, "pfJtVsRefPart[5]/I");
    pfcandTreeAna_p->Branch("pfVsTau", pfVsTau_, "pfVsTau[5][3][6]/F");
    ...
    pfcandTreeAna_p->Branch("pfJtSKSigma", pfJtSKSigma_, "pfJtSKSigma[5][3]/F");
    pfcandTreeAna_p->Branch("pfJtSKRefPart", pfJtSKRefPart_, "pfJtSKRefPart[5]/I");
    pfcandTreeAna_p->Branch("pfSKTau", pfSKTau_, "pfSKTau[5][3][6]/F");
    ...
    trkTreeAna_p->Branch("trkJtRawSigma", trkJtRawSigma_, "trkJtRawSigma[5][3]/F");
    trkTreeAna_p->Branch("trkJtRawRefPart", trkJtRawRefPart_, "trkJtRawRefPart[5]/I");
    trkTreeAna_p->Branch("trkRawTau", trkRawTau_, "trkRawTau[5][3][6]/F");
    ...
    trkTreeAna_p->Branch("trkJtSKSigma", trkJtSKSigma_, "trkJtSKSigma[5][3]/F");
    trkTreeAna_p->Branch("trkJtSKRefPart", trkJtSKRefPart_, "trkJtSKRefPart[5]/I");
    trkTreeAna_p->Branch("trkSKTau", trkSKTau_, "trkSKTau[5][3][6]/F");
  ...
  if(montecarlo){
    ...
    genTreeAna_p->Branch("genJtRawSigma", genJtRawSigma_, "genJtRawSigma[5][3]/F");
    genTreeAna_p->Branch("genJtRawRefPart", genJtRawRefPart_, "genJtRawRefPart[5]/I");
    genTreeAna_p->Branch("genRawTau", genRawTau_, "genRawTau[5][3][6]/F");
    ...
    genTreeAna_p->Branch("genJtSKSigma", genJtSKSigma_, "genJtSKSigma[5][3]/F");
    genTreeAna_p->Branch("genJtSKRefPart", genJtSKRefPart_, "genJtSKRefPart[5]/I");
    genTreeAna_p->Branch("genSKTau", genSKTau_, "genSKTau[5][3][6]/F");
    ...
    genTreeAna_p->Branch("genJtSUBESigma", genJtSUBESigma_, "genJtSUBESigma[5][3]/F");
    genTreeAna_p->Branch("genJtSUBERefPart", genJtSUBERefPart_, "genJtSUBERefPart[5]/I");
    genTreeAna_p->Branch("genSUBETau", genSUBETau_, "genSUBETau[5][3][6]/F");
